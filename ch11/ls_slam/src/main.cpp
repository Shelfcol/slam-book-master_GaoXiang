...
int main(int argc, char **argv)
{
   ...
   // std::string VertexPath = "/home/gxf/catkin_ws/src/ls_slam/data/test_quadrat-v.dat";
    //std::string EdgePath = "/home/gxf/catkin_ws/src/ls_slam/data/test_quadrat-e.dat";

       std::string VertexPath = "/home/gxf/catkin_ws/src/ls_slam/data/intel-v.dat";
        std::string EdgePath = "/home/gxf/catkin_ws/src/ls_slam/data/intel-e.dat";
    ...
    for (int i = 0; i < maxIteration; i++)
    {
        ...
        if (maxError < epsilon)
            break;
        std::cout << "Iterations:" << i << "this error=" << ComputeError(Vertexs, Edges) << std::endl;
    }
